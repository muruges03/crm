...
<template>
  ...
  <div class="leading-normal tracking-normal text-white bg-gradient-to-r from-red-500  to-yellow-500" style="font-family: 'Source Sans Pro', sans-serif;">
    <!--Nav-->
        ...
        <Popover class="relative ">
            <div class="max-w-7xl mx-auto px-4">
                ...
                <div class="flex justify-start lg:w-0 lg:flex-1">
                    <a href="#">
                        ...
                        <img class="" src="/assets/modocrm_logo.png" alt=""  width="180" height="120" >
                    </a>
                </div>
                ...
                <div class="hidden md:flex items-center justify-end md:flex-1 lg:w-0">
                    <inertia-link :href="route('login')" class="mx-auto lg:mx-0 hover:underline bg-gradient-to-r from-red-500 to-yellow-500 text-white font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">
                        Log in
                    </inertia-link>
                    </div>
                </div>
            ...
            <transition enter-active-class="duration-200 ease-out" enter-from-class="opacity-0 scale-95" enter-to-class="opacity-100 scale-100" leave-active-class="duration-100 ease-in" leave-from-class="opacity-100 scale-100" leave-to-class="opacity-0 scale-95">
                ...
                <div class="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 bg-white divide-y-2 divide-gray-50">
                    ...
                    <div>
                        <a href="#" class="mx-auto lg:mx-0 hover:underline bg-gradient-to-r from-red-500 to-yellow-500 text-white font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out"> Sign up </a>
    ...
    <section class="bg-white border-b py-8">
      <div class="container max-w-5xl mx-auto m-8">
        ...
        <div class="w-full mb-4">
          <div class="h-1 mx-auto bg-gradient-to-r from-red-500  to-yellow-500 w-64 opacity-25 my-0 py-0 rounded-t"></div>
        </div>
        ...
        <div class="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
          ...
          <div class="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow p-6">
            <div class="flex items-center justify-start">
              <button class="mx-auto lg:mx-0 hover:underline bg-gradient-to-r from-red-500  to-yellow-500 text-white font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">
                Action
              </button>
            </div>
          </div>
        ...
        <div class="flex flex-col sm:flex-row justify-center pt-12 my-12 sm:my-4">
          ...
          <div class="flex flex-col w-5/6 lg:w-1/3 mx-auto lg:mx-0 rounded-lg bg-white mt-4 sm:-mt-6 shadow-lg z-10">
            <div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
              ...
              <div class="h-1 w-full bg-gradient-to-r from-red-500  to-yellow-500 my-0 py-0 rounded-t"></div>
...
export default {
  components: {
    ...
    ChevronDownIcon,
    MenuIcon,
    XIcon,Disclosure, DisclosureButton, DisclosurePanel, Menu, MenuButton, MenuItem, MenuItems , BellIcon
  },
  setup() {
    return {
      features,
