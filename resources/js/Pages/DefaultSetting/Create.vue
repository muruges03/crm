            ...
            <div class="shadow-lg rounded-md">
                <h2 class="text-lg font-semibold flex px-4 py-2">
                    <inertia-link class="hover:text-black-600 mt-1 flex" :href="route('defaultSetting.index')">
                        <img src="/assets/add-product.png" class="w-6 h-6 mr-3">Create Default Ledger Setting
                    </inertia-link>
                </h2>
                <div class="px-4 py-4">
                    <form  @submit.prevent="store" >
                        ...
                        <div class="grid grid-cols-12 gap-4">
                            <div class="col-span-12 sm:col-span-2">
                                ...
                                <Multiselect :value="this.type"  :multiple="false" v-model="form.type" select-label="" class="!block" deselect-label=""
                            ...
                            <div class="col-span-12 sm:col-span-2">
                                ...
                                <Multiselect :value="this.ledger.id" class="!block"  :multiple="false" v-model="form.ledger_id" select-label="" deselect-label="" track-by="id" label="title"
...
export default {
    ...
    methods: {
        ...
        store() {
            // alert();
            this.form.post(this.route('defaultSetting.store'))
        },
    },
}
