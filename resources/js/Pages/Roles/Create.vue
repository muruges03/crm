    ...
    <h2 class="text-xl lg:pl-64 ml-8 sm:pt-6">
     ...
     <div class="lg:pl-64 flex flex-col bg-white divide-x divide-gray-200 border-2 shadow-md">
        <div class=" md:col-span-2 p-5">
            <form @submit.prevent="store" enctype="multipart/form-data" class="border-2">
                <div class="shadow overflow-visible sm:rounded-md">
                        ...
                        <div class="grid grid-cols-6 gap-4">
                            ...
                            <div class="col-span-6 sm:col-span-4">
                                <label for="Permissions" class="block text-sm font-medium text-gray-700">Available Permissions</label>
                                    <Multiselect  :value="options.id" :multiple="true" v-model="form.permissions" track-by="id" label="name" class="z-auto !block"
                            ...
                            <div class="col-span-6 sm:col-span-2">
                                ...
                                <input type="text" readonly v-model="form.guard_name"  id="guard_name" autocomplete="guard_name" required class=" focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" />
                    ...
                    <div class="flex justify-center p-2">
                        ...
                        CREATE<i class="fa fa-user-o" style="padding-left: 10px;font-size: 0.9em" aria-hidden="true"></i>
                        </button>
                    </div>
                </div>
            </form>
